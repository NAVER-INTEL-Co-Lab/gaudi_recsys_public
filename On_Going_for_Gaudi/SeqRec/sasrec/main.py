...
parser.add_argument('--dataset', default='Video_Games_processed')
...
# parser.add_argument('--device', default='hpu', type=str, help='cpu, hpu, gpu -> num')
parser.add_argument('--device', default='4', type=str, help='cpu, hpu, gpu -> num')
